...
$allSection = sections::all();
$allpro = products::all();
return view('invoice.edit_state', ['old_data' => $old_date, 'allSection' => $allSection, 'allpro' => $allpro]);
}
...
invoice_details::create(['id_invoice']);
}
}
/**
...
rename(public_path('attachment/' . $request->old_invoice_number), public_path('attachment/' .
